  ...
  Widget build(BuildContext context)
  {
    ...
    (
      ...
      (
        ...
        title: Text('Reaplicação', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
        // actions: <Widget>
        // [
        //   Container
        //   (
                          ...
                          (
                            ...
                            [
                              ...
                              (
                                ...
                                children: <Widget>
                                [
                                  Text('Data: 2019-08-23', style: TextStyle(color: Colors.blueAccent)),
                                  Row
                                  (
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>
                                    [
                                      Text('Quantidade: 11', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 15.0)),
